...
?>
<div class="trimvia-checkout-login-group">
	...
	<form class="woocommerce-form woocommerce-form-login login trimvia-checkout-login-form" method="post" style="display:none;">
		...
		<div class="trimvia-checkout-login-footer">
			<div class="trimvia-checkout-login-meta">
			...
			<div class="trimvia-checkout-login-submit">
